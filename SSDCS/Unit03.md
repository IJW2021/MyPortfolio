...
Started to think about the project and in particular authentication of client so built a domain controller vm to try out some ideas and manged to write a python script that would authenticate against the windows active directory. One that may take forward into our team project
